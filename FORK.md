...
| File                                                          | Change                                                                                   |
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `src/common/types/ipc.ts`                                     | IPC methods for Playnite, Steam URI, Collection backup, `cacheSteamHero`, Collection art |
...
`localart://` (HTTP origins cannot load `file://`). Custom Collection art
